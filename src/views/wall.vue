...
<!-- publications -->
	<b-card title="" sub-title="" v-for="item in allPosts" :key="item.id" class="post">
		<div class='headerCard'  >
			<b-link><b-img   src="https://picsum.photos/50" fluid alt="Responsive image" class="authorImg"></b-img></b-link>
				<div class='textHeader' >
					<b-link><span   class="authorPost">{{item.user.pseudo}}</span></b-link>
